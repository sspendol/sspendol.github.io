...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5419565149046037861)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5419565000887037860)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(5419565149046037861)
,p_button_name=>'CLOSE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(5419565214203037861)
,p_name=>'Close Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(5419565000887037860)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(5419575064882037872)
,p_event_id=>wwv_flow_api.id(5419565214203037861)
,p_event_result=>'TRUE'
